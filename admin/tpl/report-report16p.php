...
$html .= "Sub Kategori";
$html .= "</th>";
$html .= "<td class='subcat border-bottom border-top' style='padding-left: 0px;width:160px;'>";
...
$html .= "Jawatan";
$html .= "</th>";
$html .= "<td class='border-bottom border-top border-right' style='padding-left: 0px;width:160px;'>";
...
$(document).ready(function() {
	...
	function _load_rpage() {
		...
		_page("#"+_xid, { _req: 'tpl', _f: _p, survey_id: _svid, catid: _catid, subcatid: _subcatid, group_id: _groupid, jawatan_id: _jawatanid });
	};
	_load_rpage();
	...
	$("button[name=btprint]").button({ icons: {primary:'ui-icon-print' }}).click(function(e) {
		...
		var _groupid = $("select[name=group_id]").attr("value");
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report16p-print&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid;
	...
	$("button[name=btpdf]").button({ icons: {primary:'ui-icon-document' }}).click(function(e) {
		...
		var _groupid = $("select[name=group_id]").attr("value");
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report16p-print&dopdf=1&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid;
		_popupnewin(_url,"print");
	});
	$("button[name=btexcel]").button({ icons: {primary:'ui-icon-document' }}).click(function(e) {
		...
		var _groupid = $("select[name=group_id]").attr("value");
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report16p-print&doexcel=1&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid;
		_popupnewin(_url,"print");
	});
});
</script>
