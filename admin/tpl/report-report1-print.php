...
if ( !_null($this->request['dopdf']) ) {
	$url = $this->baseurl."/?_req=tpl&_f=report-report1-print&survey_id=".$this->request['survey_id']."&noprint=1&nl=1";
...
if ( !_null($this->request['doexcel']) ) {
    ...
    header("Content-Disposition: inline; filename=\"report1.xls\"");
}
?>
<html>
<head>
