...
$html .= "<th class='border-bottom border-top border-left' style='width:60px;padding-left: 6px;'>";
$html .= "Jawatan";
$html .= "</th>";
...
$(document).ready(function() {
	...
	$("button[name=btprint]").button({ icons: {primary:'ui-icon-print' }}).click(function(e) {
		...
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
        var _stateid = $("select[name=state_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report19p-print&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid+"&state_id="+_stateid;
	...
	$("button[name=btpdf]").button({ icons: {primary:'ui-icon-document' }}).click(function(e) {
		...
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
        var _stateid = $("select[name=state_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report19p-print&dopdf=1&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid+"&state_id="+_stateid;
		_popupnewin(_url,"print");
	});
	$("button[name=btexcel]").button({ icons: {primary:'ui-icon-document' }}).click(function(e) {
		...
		var _jawatanid = $("select[name=jawatan_id]").attr("value");
        var _stateid = $("select[name=state_id]").attr("value");
		var _url = _baseurl+"/?_req=tpl&_f=report-report19p-print&doexcel=1&survey_id="+_svid+"&catid="+_catid+"&subcatid="+_subcatid+"&group_id="+_groupid+"&jawatan_id="+_jawatanid+"&state_id="+_stateid;
		_popupnewin(_url,"print");
	});
});
</script>
