...
foreach( array("year" => _tr("Tahun") ) as $x => $y ) {
...
$html_ops .= "<button class='button button_add' name='btadd'>"._tr("Tambah")."</button></td>";
$html_ops .= "</tr>";
...
if ( _num($this->{$repclass}->data->total) && $this->{$repclass}->data->total > 0 ) {
	...
	$html .= "<th style='width:100px;'>"._tr("Aktif")."</th>";
	$html .= "<th style='width:50px;'>"._tr("Tahun")."</th>";
	$html .= "<th>"._tr("Bulan")."</th>";
	$html .= "<th style='width:100px;'>"._tr("Tarikh Mula")."</th>";
	$html .= "<th style='width:100px;'>"._tr("Tarikh Tamat")."</th>";
	$html .= "</tr>";
	...
	while( $data = @array_shift($this->{$repclass}->data->data) ) {
		...
		$html .= "<td class='border-left border-bottom info'>".ucwords($data['status'])."</td>";
		$html .= "<td class='border-left border-bottom info'>".$data['year']."</td>";
		$html .= "<td class='border-left border-bottom info'>".strtoupper($data['month'])."</td>";
	...
	$html .= "<center><table id='x-table1'>";
		...
		$html .= "<button class='button button_add' name='btadd'>"._tr("Tambah")."</button></td></tr>";
