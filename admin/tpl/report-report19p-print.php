...
<tr><td colspan='".( $isbahantanaman ? "22" : "21" )."' class='title'>Maklumat terperinci Gunatenaga Bagi Sektor Peniaga Mengikut Kategori{$category_name}Dan Jawatan{$jawatan_name}Bagi Lain-lain Bukan Warganegara{$state_name}- {$smonth} {$syear}</td></tr>
<tr>
