...
<tr><td colspan='21' class='title'>Maklumat terperinci Gunatenaga Bagi Sektor Kilang Mengikut Kategori{$category_name}Dan Jawatan{$jawatan_name}Bagi Lain-lain Warganegara{$state_name}- {$smonth} {$syear}</td></tr>
<tr>
