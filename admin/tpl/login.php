...
<img id="logo" src="<?php _E($this->pbaseurl);?>/rsc/logob.png">
</div>-->
<br>
<br>
<br>
...
<tr><td><br></td></tr>
<tr>
<td>Paparan terbaik dalam <a href="http://www.google.com/chrome/">Google Chrome</a> atau <a href="http://www.microsoft.com/windows/internet-explorer/default.aspx">Internet Explorer 9.0</a> ke atas dengan 1024x768 resolusi piksel</td>
</tr>
</table>
</div>
<?php endif; ?>
...
<img src="<?php _E($this->pbaseurl);?>/rsc/imag5.jpg" width="150" style="float:left;margin-right:5px;">
<img src="<?php _E($this->pbaseurl);?>/rsc/imag1.jpg" width="150" style="float:left;margin-right:5px;">
<img src="<?php _E($this->pbaseurl);?>/rsc/imag2.jpg" width="150" style="float:left;margin-right:5px;">
<img src="<?php _E($this->pbaseurl);?>/rsc/imag3.jpg" width="150" style="float:left;margin-right:5px;">
<img src="<?php _E($this->pbaseurl);?>/rsc/imag4.jpg" width="150" style="float:left;margin-right:5px;">
<img src="<?php _E($this->pbaseurl);?>/rsc/imag6.jpg" width="150" style="float:right;">
</div> <!-- /image -->
</center>
