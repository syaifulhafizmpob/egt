...
/*h101_init.e101_bln as `bulan`,
h101_init.e101_thn as `tahun`,
h101_init.e101_flg,
reg_pelesen.e_kat,
pelesen.e_negeri,*/
...
FROM
pelesen
INNER JOIN h101_init ON pelesen.e_nl = h101_init.e101_nl
Inner Join `reg_pelesen` ON `pelesen`.`e_nl` = `reg_pelesen`.`e_nl`
INNER JOIN negeri ON pelesen.e_negeri = negeri.kod_negeri
where `reg_pelesen`.`e_kat` ='PL101' and h101_init.e101_bln='@MONTH' and h101_init.e101_thn='@YEAR' and e101_flg='3'
