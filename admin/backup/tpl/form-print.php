...
if ( !_null($this->request['dopdf']) ) {
	$url = $this->baseurl."/?_req=tpl&_f=form-print&sid=".$this->request['sid']."&rid=".$this->request['rid']."&nl=1";
...
<th colspan='5' rowspan='1' style='vertical-align: top;' class='border-top border-left border-bottom border-right-none'>Warganegara Tempatan</th>
<th colspan='3' rowspan='1' style='vertical-align: top;' class='border-top border-left border-bottom border-right-none'>Pendapatan</th>
<th colspan='5' rowspan='1' style='vertical-align: top;' class='border-top border-left border-bottom border-right-none'>Warganegara Asing</th>
<th colspan='3' rowspan='1' style='vertical-align: top;' class='border-top border-left border-bottom border-right-none'>Pendapatan</th>
<th colspan='3' rowspan='1' style='vertical-align: top;' class='border-top border-left border-right border-bottom'>Bilangan Pekerja</th>
</tr>
<tr>

<td colspan='8' rowspan='1' style='vertical-align: top;' class='border-left border-bottom'>Bilangan Pekerja</td>
<td colspan='8' rowspan='1' style='vertical-align: top;' class='border-left border-bottom'>Bilangan Pekerja</td>
	...
	while( $rl = @array_shift($list1) ) {
		...
		if ( _null($h1_a[$h1]) ) {
            ...
            if ( _null($this->request['noprint']) || !_null($this->request['dopdf']) ) {
                if ( $fln == 1 || $fln == 2 ) {
                    $hg = ( $this->request['sid'] == 2 ? 80 : 95 );
                    if ( $this->request['sid'] == 2 && $fln == 2 ) $hg = $hg + 50;
                    $pbreak = true;
                    for($tt = 0; $tt <= $hg; $tt++) {
...
<tr>
<th style="width:250px;font-size:13px;">TELEPHONE</th>
<td style="font-size:13px;">: <?php _E(strtoupper($this->fdb->phone));?></td>
</tr>
<tr>
<th style="width:250px;font-size:13px;">FAX</th>
