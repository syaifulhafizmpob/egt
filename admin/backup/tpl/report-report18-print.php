...
if ( !_null($this->request['dopdf']) ) {
	$url = $this->baseurl."/?_req=tpl&_f=report-report18-print&survey_id=".$this->request['survey_id']."&noprint=1&nl=1";
...
<tr><td colspan='21' class='title'>Maklumat terperinci Gunatenaga  Bagi Sektor kilang Mengikut Kategori Dan Jawatan Bagi Lain-lain Warganegara {$smonth} {$syear}</td></tr>
<tr>
