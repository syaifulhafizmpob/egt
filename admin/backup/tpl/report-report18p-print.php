...
if ( !_null($this->request['dopdf']) ) {
	$url = $this->baseurl."/?_req=tpl&_f=report-report18p-print&survey_id=".$this->request['survey_id']."&noprint=1&nl=1";
...
<tr><td colspan='21' class='title'>Maklumat terperinci Gunatenaga  Bagi Sektor Peniaga Mengikut Kategori Dan Jawatan Bagi Lain-lain Warganegara {$smonth} {$syear}</td></tr>
<tr>
