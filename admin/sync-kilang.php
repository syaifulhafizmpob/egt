...
$ddb = new nwdb("10.0.2.43","egt","egt123","ekilang_main");
...
foreach( array("kilangbuah","kilangisirung","kilangoleokimia","kilangpenapis","pusatsimpanan") as $kl) {
echo "############ ".$kl."{$nl}";
$f = "/var/www/html/egunatenaga/admin/sql/ekilang_main/".$kl.".sql";
if ( !file_exists($f) ) {
	echo "!!! $f not found";
	continue;
}
