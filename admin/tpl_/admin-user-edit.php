...
<tr>
<th><?php _t("Login");?></th>
<td><input type="text" name="login" class="text" value="<?php _E($fdb->login);?>"></td>
</tr>
...
if ( _array($catl) ) {
	...
	while( $rt = @array_shift($catl) ) {
		echo "<tr><td style='width:200px;'>".$rt['name']."</td><td style='padding-left: 5px;'><input type='checkbox' name='groups[".$rt['id']."]' value='1'".( $fdb->level == "staff" && $this->user->_ingroup($fdb->id, $rt['id']) ? " checked" : "")."></td></tr>";
	}
	echo "</table>";
}
?>
...
if ( _array($catl) ) {
	echo "<table>";
	while( $rt = @array_shift($catl) ) {
		echo "<tr><td style='width:200px;'>".$rt['name']."</td><td style='padding-left: 5px;'><input type='checkbox' name='groups[".$rt['id']."]' value='1'".( $this->user->_ingroup($fdb->id, $rt['id']) ? " checked" : "")."></td></tr>";
	}
	echo "</table>";
}
?>
...
<fieldset class="x-fb">
<legend class="x-title"><?php _t("Katalaluan");?></legend>
<table id="x-table">
<tr>
<th><?php _t("Katalaluan");?></th>
<td><input type="password" name="npass" class="text" value=""></td>
</tr>

<tr>
<th><?php _t("Taip semula katalaluan");?></th>
