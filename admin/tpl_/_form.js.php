...
?>
	...
	$("#"+_gridid+" img[data-edit],#"+_gridid+" button[data-edit]").live("click", function(e) {
		e = e || window.event;
		e.preventDefault();
	...
	$("#"+_gridid+" img[data-view]").live("click", function(e) {
		e = e || window.event;
		e.preventDefault();
		var _id = $(this).attr("data-view");
		_popupfull(_pbaseurl+"/?_req=adminview&ord="+_id,"form"+time());
	});
