...
function _fixbg() {
    if ( $(window).width() <= 1024 ) {
        $("html").css("background-image", _baseurl+"/rsc/bg2.jpg");
        $("div#bb").css("margin-top","80px");
        $("img#logo").attr("src", _baseurl+"/rsc/logoa.png");
    } else {
        $("html").css("background-image", _baseurl+"/rsc/bg1.jpg");
        $("div#bb").css("margin-top","110px");
        $("img#logo").attr("src", _baseurl+"/rsc/logob.png");
    }
};
...
$(document).ready(function() {
	...
	$("input[name=uname]").bind("keyup", function(e) {
		e = e || window.event;
